...
export default function Register() {
  ...
  const payload = { fullName: name, email, contact, password };
        ...
        <div className="auth-left">
          ...
          <div className="auth-left-content">
            ...
            <p className="auth-left-desc">
              Join the collective — start shipping extraordinary products today.
            </p>
          </div>
        </div>
        ...
        <div className="auth-right">
          <div className="auth-form-wrap">
            ...
            <h1 className="auth-heading">
              <ElasticText text="Create Account" />
            </h1>
            <p className="auth-sub">
              Join the collective. Let's build the future together.
            </p>
            ...
            <form onSubmit={handleSubmit} className="auth-form">
              ...
              <MagneticButton type="submit" className="auth-submit">
                <StaggeredText text="CREATE ACCOUNT →" />
              </MagneticButton>
